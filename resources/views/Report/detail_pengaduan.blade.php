...
<div class="container-xxl flex-grow-1 container-p-y">            
  <h4 class="py-3 mb-4">
    <span class="text-muted fw-light">SIMPEDU ></span> Info Pengaduan
  </h4>
  <div class="row">
    <div class="col-md-6">
      <div class="card mb-4">
        <h5 class="card-header">Detail Pengaduan</h5>
                ...
                <div class="row">
                  <div class="col-md-12" >
                    <div class="form-group">
                      ...
                      <select class="form-control" name="id_ruangan"  id="exampleFormControlSelect1" aria-label="Default select example" disabled>
