...
<div class="container-xxl flex-grow-1 container-p-y">            
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card mb-4">
        <h5 class="card-header">Form Edit Ruangan</h5>
        <form method="POST" action="{{ route('ruangan-update', $data->id) }}" enctype='multipart/form-data'>
          ...
          <div class="card-body">
            <div>
              ...
              <input type="text" class="form-control" name="nama_ruangan" value="{{ $data->nama_ruangan }}" id="defaultFormControlInput" placeholder="" aria-describedby="defaultFormControlHelp">        
            </div>
              <div id="defaultFormControlHelp" class="form-text"></div>
              <div>
              <label for="defaultFormControlInput" class="form-label">Lokasi Ruangan</label>
              <input type="text" class="form-control" name="lokasi_ruangan" value="{{ $data->lokasi_ruangan }}" id="defaultFormControlInput" placeholder="" aria-describedby="defaultFormControlHelp">
